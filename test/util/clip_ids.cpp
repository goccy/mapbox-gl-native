...
TEST(ClipIDs, Bug206) {
    ...
    ASSERT_EQ(Stencil(TileID{ 11, 326, 791, 10 }, { "00001111", "00000111"}), *it++);
    ASSERT_EQ(Stencil(TileID{ 12, 654, 1582, 10 }, { "00001111", "00001000"}), *it++);
    ASSERT_EQ(Stencil(TileID{ 12, 654, 1583, 10 }, { "00001111", "00001001"}), *it++);
    ASSERT_EQ(Stencil(TileID{ 12, 655, 1582, 10 }, { "00001111", "00001010"}), *it++);
    ASSERT_EQ(Stencil(TileID{ 12, 655, 1583, 10 }, { "00001111", "00001011"}), *it++);
    ASSERT_EQ(stencils.end(), it);
}
